...
| ES    | Command |
| ----- | ------- |
| 6.8.0 | `bin/elasticsearch-plugin install https://github.com/spinscale/elasticsearch-ingest-langdetect/releases/download/688.0.1/ingest-langdetect-6.8.0.1.zip` |
